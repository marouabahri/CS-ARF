...
//ssssimport org.kramerlab.autoencoder.math.matrix.Mat;
 ...
 * @version $Revision: 7 $
 */
public class HoeffdingAdaptiveRegressionTree extends HoeffdingRegressionTree {
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public interface NewNode {
        ...
        public void killTreeChilds(HoeffdingAdaptiveRegressionTree ht);

        public void learnFromInstance(Instance inst, HoeffdingAdaptiveRegressionTree ht, SplitNode parent, int parentBranch);
    ...
    public static class AdaSplitNodeForRegression extends SplitNode implements NewNode {
        ...
        public AdaSplitNodeForRegression(InstanceConditionalTest splitTest,
                ...
                if (this.getErrorWidth() > 300 && ((NewNode) this.alternateTree).getErrorWidth() > 300) {
                    ...
                    if (Bound < oldErrorRate - altErrorRate) {
                        ...
                        if (parent != null) {
                            ...
                            // Switch root tree
                            ht.treeRoot = ((AdaSplitNodeForRegression) ht.treeRoot).alternateTree;
                        }
                        ...
                        if (this.alternateTree instanceof ActiveLearningNodeForRegression) {
                            ...
                            ((AdaSplitNodeForRegression) this.alternateTree).killTreeChilds(ht);
                        }
        ...
        public void killTreeChilds(HoeffdingAdaptiveRegressionTree ht) {
            for (Node child : this.children) {
                if (child != null) {
                    ...
                    if (child instanceof AdaSplitNodeForRegression && ((AdaSplitNodeForRegression) child).alternateTree != null) {
                        ((NewNode) ((AdaSplitNodeForRegression) child).alternateTree).killTreeChilds(ht);
                        ht.prunedAlternateTrees++;
                    }
                    //Recursive delete of SplitNodes
                    if (child instanceof AdaSplitNodeForRegression) {
    ...
    public static class AdaLearningNodeForRegression extends PerceptronLearningNode implements NewNode {
        ...
        public AdaLearningNodeForRegression(double[] initialClassObservations, LearningNodePerceptron p) {
        ...
        public double[] getClassVotes(Instance inst, HoeffdingTree ht) {
            double[] dist;
            boolean predictionOption = ((HoeffdingAdaptiveRegressionTree) ht).meanPredictionNodeOption.isSet();
    ...
    protected LearningNode newLearningNode(double[] initialClassObservations, LearningNodePerceptron p) {
        ...
        return new AdaLearningNodeForRegression(initialClassObservations,p);
    }
    @Override
    ...
    protected SplitNode newSplitNode(InstanceConditionalTest splitTest,
                                     double[] classObservations, int size) {
        return new AdaSplitNodeForRegression(splitTest, classObservations, size);
    }

    @Override
    protected SplitNode newSplitNode(InstanceConditionalTest splitTest,
                                     double[] classObservations) {
        return new AdaSplitNodeForRegression(splitTest, classObservations);
    }
