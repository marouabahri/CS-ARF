 ...
 * @version $Revision: 7 $
 */
public class HoeffdingAdaptiveTree1 extends  CS_HoeffdingTree{
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public interface NewNode {
        ...
        public void killTreeChilds(HoeffdingAdaptiveTree1 ht);

        public void learnFromInstance(Instance inst, HoeffdingAdaptiveTree1 ht, SplitNode parent, int parentBranch);
    ...
    public static class AdaLearningNode extends LearningNodeNBAdaptive implements NewNode {
        ...
        public double[] getClassVotes(Instance inst, CS_HoeffdingTree ht) {
            double[] dist;
            int predictionOption = ((HoeffdingAdaptiveTree1) ht).leafpredictionOption.getChosenIndex();
