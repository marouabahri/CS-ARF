 ...
 */
public class CS_ARFHoeffdingTree extends CS_HoeffdingTree {
    ...
    public static class RandomLearningNode extends CS_HoeffdingTree.ActiveLearningNode {
...
//                        }
    ...
    public CS_ARFHoeffdingTree() {
        this.removePoorAttsOption = null;
    }
    
    @Override
    protected CS_HoeffdingTree.LearningNode newLearningNode(double[] initialClassObservations) {
        CS_HoeffdingTree.LearningNode ret;
