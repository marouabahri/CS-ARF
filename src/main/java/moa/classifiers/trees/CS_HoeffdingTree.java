 ...
 * @author Richard Kirkby (rkirkby@cs.waikato.ac.nz)
 * @version $Revision: 7 $
 * @author Maroua Bahri update for the CS-ARF
 */
public class CS_HoeffdingTree extends AbstractClassifier implements MultiClassClassifier {
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, CS_HoeffdingTree ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(CS_HoeffdingTree ht, StringBuilder out,
                int indent) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, CS_HoeffdingTree ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, CS_HoeffdingTree ht) {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, CS_HoeffdingTree ht) {
    ...
    public IntOption dim = new IntOption("FeatureDimension", 'a',
    ...
    protected InstancesHeader streamHeader=null;
	...
	inst = transformedInstance(inst, GaussianProjection(inst,this.dim.getValue(), this.GaussMatrix));
	inst.setDataset(this.streamHeader);
        if (this.treeRoot == null) {
    ...
    public double[] getVotesForInstance(Instance inst) {
        ...
        GaussianProjection(inst,this.dim.getValue(), this.GaussMatrix));
        inst.setDataset(this.streamHeader);
        if (this.treeRoot != null) {
