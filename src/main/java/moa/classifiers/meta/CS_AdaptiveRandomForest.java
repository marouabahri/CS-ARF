...
import moa.classifiers.trees.CS_ARFHoeffdingTree;
 ...
 *
 * @author Heitor Murilo Gomes (heitor_murilo_gomes at yahoo dot com dot br)
 * @revisited Maroua Bahri
 */
public class CS_AdaptiveRandomForest extends AbstractClassifier implements MultiClassClassifier {
    ...
    public ClassOption treeLearnerOption = new ClassOption("treeLearner", 'l',
            "Random Forest Tree.", CS_ARFHoeffdingTree.class,
            "CS_ARFHoeffdingTree -e 2000000 -g 50 -c 0.01");
    ...
    public void resetLearningImpl() {
        ...
        if(numberOfJobs != CS_AdaptiveRandomForest.SINGLE_THREAD && numberOfJobs != 1)
...
//        BasicClassificationPerformanceEvaluator classificationEvaluator = (BasicClassificationPerformanceEvaluator) getPreparedClassOption(this.evaluatorOption);
        ...
        switch(this.mFeaturesModeOption.getChosenIndex()) {
            case CS_AdaptiveRandomForest.FEATURES_SQRT:
                this.subspaceSize = (int) Math.round(Math.sqrt(n)) + 1;
                break;
            case CS_AdaptiveRandomForest.FEATURES_SQRT_INV:
                this.subspaceSize = n - (int) Math.round(Math.sqrt(n) + 1);
                break;
            case CS_AdaptiveRandomForest.FEATURES_PERCENT:
        ...
        CS_ARFHoeffdingTree treeLearner = (CS_ARFHoeffdingTree) getPreparedClassOption(this.treeLearnerOption);
        ...
        for(int i = 0 ; i < ensembleSize ; ++i) {
            ...
            this.ensemble[i] = new ARFBaseLearner(
                i, 
                (CS_ARFHoeffdingTree) treeLearner.copy(), 
    ...
    protected final class ARFBaseLearner {
        ...
        public CS_ARFHoeffdingTree classifier;
        ...
        private void init(int indexOriginal, CS_ARFHoeffdingTree instantiatedClassifier, BasicClassificationPerformanceEvaluator evaluatorInstantiated, 
        ...
        public ARFBaseLearner(int indexOriginal, CS_ARFHoeffdingTree instantiatedClassifier, BasicClassificationPerformanceEvaluator evaluatorInstantiated, 
                    long instancesSeen, boolean useBkgLearner, boolean useDriftDetector, ClassOption driftOption, ClassOption warningOption, boolean isBackgroundLearner) {
            ...
            if(this.useDriftDetector && !this.isBackgroundLearner) {
                ...
                if(this.useBkgLearner) {
                    ...
                    if(this.warningDetectionMethod.getChange()) {
                        ...
                        CS_ARFHoeffdingTree bkgClassifier = (CS_ARFHoeffdingTree) this.classifier.copy();
